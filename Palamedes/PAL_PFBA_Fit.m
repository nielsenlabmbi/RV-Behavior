...
%varargin is causing issues, can just rn the function listing 'grid and PF'


function [paramsValues, posterior] = PAL_PFBA_Fit(StimLevels, NumPos, OutOfNum, grid, PF ) %PAL_PFBA_Fit(StimLevels, NumPos, OutOfNum, varargin)
...
%RV 9/6/23 varargin was causing issues so I commended out the 'if---else
%secontions containing it and gout outputs! Now are those sensible
%outputs.. and why are thy not saved?